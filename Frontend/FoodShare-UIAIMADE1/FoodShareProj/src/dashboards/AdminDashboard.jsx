...
import { 
  ...
  FiMap, FiSettings, FiFileText, FiBarChart2, FiActivity
} from 'react-icons/fi';
...
const AdminDashboard = ({ user }) => {
  ...
  useEffect(() => {
    const loadDashboardData = async () => {
      try {
        ...
        // Simulate fetchDashboardStats API call
        const mockStats = {
          totalUsers: 248,
          totalDonors: 112,
  ...
  const handleSendNotification = (type, message) => {
    // This would integrate with the notification service in a real app
